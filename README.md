...
By default, the `thirdparty.rc` reference classifier configuration file is read on startup. It classifies some references in third-party frameworks. Specifically:
