...
namespace MemorySnapshotAnalyzer.AnalysisTests
{
    ...
    public sealed class BacktracerTest
    {
        ...
        Backtracer MakeBacktracer(MockTraceableHeap traceableHeap, Backtracer.Options options, int gcHandleWeight)
        {
            m_traceableHeap = traceableHeap;
            m_rootSet = new RootSet(m_traceableHeap, gcHandleWeight);
            m_tracedHeap = new TracedHeap(m_rootSet!);
            m_backtracer = new Backtracer(m_tracedHeap, options, m_memoryLogger!);
            return m_backtracer;
        }
        ...
        {
            Backtracer backtracer = MakeBacktracer(new BasicTraceableHeap(), Backtracer.Options.None, gcHandleWeight: 0);
        ...
        public void TestMultipleReferencesFromDifferentObjects()
        {
            ...
            Backtracer backtracer = MakeBacktracer(traceableHeap, Backtracer.Options.None, gcHandleWeight: 0);
